...
const translations = {
  'zh-CN': {
    ...
    knowledge: {
      ...
      empty: '暂无内容，可点击「从 iOAbot 导入」',
      draft: '待审核',
      review_pass: '审核通过', delete: '删除',
      import_from_ioabot: '从 iOAbot 导入', importing: '导入中...',
      import_done: '导入完成：错题 {0} · 成功路径 {1} · 知识 {2} · 用例 {3}（跳过 {4}）',
      import_failed: '导入失败',
      search_placeholder: '检索知识（如：腾讯文档 创建文档）', search: '检索', searching: '检索中...',
  ...
  'en': {
    ...
    knowledge: {
      ...
      empty: 'Empty. Use "Import from iOAbot" first.',
      draft: 'Draft',
      review_pass: 'Approve', delete: 'Delete',
      import_from_ioabot: 'Import from iOAbot', importing: 'Importing...',
