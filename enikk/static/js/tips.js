...
const TIPS = [
  ...
  {
    'zh-CN': '🔐 请使用管理员权限运行 Manufex，如此它才能启动 app 进程。',
    en: '🔐 Please run Manufex as administrator so it can launch app processes.',
  },
  {
    'zh-CN': '🖱️ Manufex 运行过程中会挪动鼠标指针哦，建议使用 IM 遥控 Manufex，这样你们两就不会因为抢鼠标而吵架',
    en: '🖱️ Manufex will move the mouse pointer during operation. Consider using IM to control it remotely, so you won\'t fight over the mouse',
  },
  {
